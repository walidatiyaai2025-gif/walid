...
$chat = $chat.Replace('public sealed class PlaywrightChatGptBrowserAdapter : IChatGptBrowserAdapter', 'public sealed class PlaywrightChatGptBrowserAdapter : IChatGptBrowserAdapter, IPhysicalSubmitAuthorizationAdapter')
